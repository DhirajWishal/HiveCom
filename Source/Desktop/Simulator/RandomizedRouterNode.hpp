...
namespace HiveCom
{
    ...
    /// This routes the incoming packet to a random child node if the current node is not the intended
    /// recipient or if the destination node is not in the child list.
